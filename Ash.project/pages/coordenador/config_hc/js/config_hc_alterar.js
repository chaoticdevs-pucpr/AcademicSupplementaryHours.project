...
async function carregarCategorias(){
    const retorno = await fetch("../php/config_hc_categorias.php");
    const resposta = await retorno.json();
...
async function carregarSubcategorias(){
    ...
    const retorno = await fetch("../php/config_hc_subcategorias.php?categoria_id=" + categoria_id);
    const resposta = await retorno.json();
...
async function alterar(){
    ...
    const retorno = await fetch("../php/config_hc_alterar.php?id=" + subcategoria_id, {
        method: "POST",
        body: fd
    });
    const resposta = await retorno.json();
